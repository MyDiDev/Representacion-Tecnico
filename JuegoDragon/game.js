...
function GokuLife() {
  // Properties.
  this.image = new Image();
  this.image.src = "Imagenes/barravidagoku.png";
  this.xPos = 18;
  this.yPos = 4;
...
function Minicell() {
  // Properties.
  this.image = new Image();
  this.image.src = "Imagenes/minicell.png";
  this.xPos = 750;
  this.yPos = 300;
  this.flag = false;
  this.died = false;
...
function Shot() {
  // Properties.
  this.image = new Image();
  this.image.src = "Imagenes/disparominicell.png";
  this.xPos = -400;
  this.yPos = -400;
...
function MinicellLife() {
  // Properties.
  this.image = new Image();
  this.image.src = "Imagenes/barravidaminicell.png";
  this.xPos = 612;
  this.yPos = 4;
...
var world = new Image();
world.src = "Imagenes/namek.jpg";
var gokulifebox = new Image();
gokulifebox.src = "Imagenes/cuadrovidagoku.png";
var minicelllifebox = new Image();
minicelllifebox.src = "Imagenes/cuadrovidaminicell.png";
var winbox = new Image();
winbox.src = "Imagenes/Hasganado.png";
var lostbox = new Image();
lostbox.src = "Imagenes/Hasperdido.png";
